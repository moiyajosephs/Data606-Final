...
The drawback of this robust function is there is no way to plo
```{r}
...
Logistic regression is also reasonable to use, since it does not have the restrictions of 
