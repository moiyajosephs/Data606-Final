...
The ideal student according this model would be a student with no romantic relationship and who goes out. 

```{r}
ideal.student.model <- lm(G3 ~ romantic + goout + freetime, data= student_mat)
summary(ideal.student.model)
```

When removing the other variables the 
